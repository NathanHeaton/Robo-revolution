...
var upgrades: Dictionary = {
	...
	"Underground":{
		"SurgeRedistributor":{
			...
			"description": "Increases surge boost effectiveness",
		...
		"Companion": {
			...
			"type": "custom",
			"first_upgrade": true,
			"first_description": "Deploys an automatic item-pushing companion",
			"description": "",
		...
		"Refinement": {
			...
			"type": "stat",
			"first_upgrade": true,
			"first_description": "Trash items give 1% income boost (max 1000%)",
